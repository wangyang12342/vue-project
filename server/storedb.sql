...
Source Host           : 192.168.1.13:13306
...
CREATE TABLE `carousel` (
  ...
  `imgPath` char(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `describes` char(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `category` (
  ...
  `category_name` char(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Records of collect
-- ----------------------------
INSERT INTO `collect` VALUES ('1', '1', '2', '1608470918744');
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('1', '11608110593485', '1', '1', '1', '1599', '1608110593485');
INSERT INTO `orders` VALUES ('2', '11608471048482', '1', '2', '1', '2599', '1608471048482');
INSERT INTO `orders` VALUES ('3', '11608471096218', '1', '16', '1', '2599', '1608471096218');
...
CREATE TABLE `product` (
  ...
  `product_title` char(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_intro` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_picture` char(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_price` double NOT NULL,
...
CREATE TABLE `users` (
  ...
  `userPhoneNumber` char(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', 'admin', 'admin123456', '13580018623');
